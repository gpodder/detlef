...
public interface PodcastDAO {
     ...
     * @return returns the number of inserted rows (if it fails then 0 will be
     * returned)
     */
     ...
     * used for this)
     * @return returns the number of deleted rows (if it fails then 0 will be
     * returned)
     */
     ...
     * @return the number of updated rows will be returned (if it fails then 0
     * will be returned)
     */
